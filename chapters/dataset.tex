...
Additional background $2\!\to\!2$ QCD processes that mimic the prompt-electron signature are modelled with \pythia8.186 (A14 tune) and the Neural Network PDF set, \textsc{nnpdf}-\\{\small2.3}\textsc{lo}. 
