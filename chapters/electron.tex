...
This information is provided by the \texttt{MCTruthClassifierTool}~\cite{} and can be uniquely accessed in our produced MC simulations.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{downsampled_MultiClass_Et_train.jpg}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{classWeighted_MultiClass_Et_train.jpg}
...
As a figure of merit for estimating the performance of our algorithm and comparing it to the LH, we use ROC curves, already described in Chapter~\ref{chap:machine_learning}. Before constructing the discriminant, we must first determine the fractions to be used.
